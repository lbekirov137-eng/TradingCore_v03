...
def protocol_dict()->dict[str,Any]:
    return {
        ...
        "risk_amount_usd":RISK_AMOUNT_USD,"reference_capital_usd":REFERENCE_CAPITAL_USD,
        "max_leverage":MAX_LEVERAGE,"max_concurrent_positions":MAX_CONCURRENT_POSITIONS,
        ...
        "portfolio_rule":"At most one open PAPER position across the entire V2 universe at any time.",
        ...
        "safety":{"spot_long_only":True,"max_leverage":1.0,"max_concurrent_positions":1,"no_averaging":True,"private_api":False,"real_orders":False,"collector_a_modified":False,"collector_b_modified":False}
    }
